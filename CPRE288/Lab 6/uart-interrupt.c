...
volatile int command_flag_go = 0; // flag to tell the main program a special command was received
...
void uart_interrupt_init(void){
  ...
  UART1_IM_R |= 0b00010000; // page 924 in Tiva_TM4C data sheet
  ...
  NVIC_EN0_R |= 0b01000000; // page 142 in Tiva_TM4C data sheet
...
void UART1_Handler(void)
{
    ...
    if ((UART1_MIS_R & 0b00010000) == 0b00010000) // page 932 in Tiva_TM4C data sheet
    {
        ...
        byte_received = (char)(UART1_DR_R & 0xFF); // page 907 in the Tiva_TM4C data sheet
