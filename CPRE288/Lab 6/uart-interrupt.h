...
extern volatile char command_byte_go; // byte value for special character used as a command
extern volatile int command_flag_go;
extern volatile char command_byte_go;
extern volatile int command_flag_stop;// flag to tell the main program a special command was received
